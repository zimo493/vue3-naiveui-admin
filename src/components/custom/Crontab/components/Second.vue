<template>
  <n-card>
    <n-radio-group v-model:value="radioValue" name="selectSecond">
      <n-grid x-gap="20" y-gap="20" :cols="1">
        <n-gi>
          <n-flex align="center">
            <n-radio :value="1" />
            {{ t("crontab.wildcard.second") }}
          </n-flex>
        </n-gi>
        <n-gi>
          <n-flex align="center">
        ...
        <n-gi>
          <n-flex align="center">
            ...
            <n-input-number
              ...
              @focus="radioChange(3)"
            />
            {{ t("crontab.second") }}{{ t("crontab.start") }}
            <n-input-number
              ...
              @focus="radioChange(3)"
            />
            {{ t("crontab.second") }}{{ t("crontab.executeOnce") }}
          </n-flex>
        </n-gi>
        <n-gi>
          <n-flex>
